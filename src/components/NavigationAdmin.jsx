        ...
        {/* <HashRouter> */}
            <ul class="nav nav-tabs navbar-expand-md pl-md-5  navbar-dark">
                ...
                <div className="collapse navbar-collapse p-0 m-0" id="navbarNavAltMarkup">
                    <li class="nav-item ">
                            <NavLink className="m-auto text-center white links nav-link" to="/"
                    ...
                    <li class="nav-item">
                            <NavLink exact={true} className="m-auto text-center white links nav-link" activeClassName="activeLinks" onClick={()=> localStorage.clear()} to="/logout">LOGOUT</NavLink>                        
                    </li>
                </div>
            </ul>
        {/* <HashRouter /> */}
